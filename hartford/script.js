...
var initFrom = dateToTS(new Date(2024, 0, 1));
var initTo = dateToTS(new Date(2024, 11, 30));

Papa.parse('./data/crashes-2024.csv', {
    download: true,
    header: true,
    dynamicTyping: true,
    complete: function (result) {
        ...
        var slider = $(".js-range-slider").ionRangeSlider({
            ...
            min: dateToTS(new Date(2024, 0, 1)),
            max: dateToTS(new Date(2024, 11, 30)),
...
L.control.attribution({
    prefix: 'View <a href="https://github.com/datavizforall/hartford-crashes">code by DataVizForAll</a> \
      and <a href="https://github.com/Picturedigits/hartford-crashes">original by PictureDigits</a>'
}).addTo(map)
